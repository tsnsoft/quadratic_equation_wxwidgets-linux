...
Quadratic_equation_wxwidgetsFrame::Quadratic_equation_wxwidgetsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    {
    	wxIcon FrameIcon;
    	FrameIcon.CopyFromBitmap(wxBitmap(wxImage(_T(".//img/qe.jpg"))));
    	SetIcon(FrameIcon);
    }
    ...
    StaticBitmap1 = new wxStaticBitmap(this, ID_STATICBITMAP1, wxBitmap(wxImage(_T(".//img/qe.jpg")).Rescale(wxSize(176,48).GetWidth(),wxSize(176,48).GetHeight())), wxPoint(112,184), wxSize(176,48), wxSIMPLE_BORDER|wxFULL_REPAINT_ON_RESIZE, _T("ID_STATICBITMAP1"));
    Center();
